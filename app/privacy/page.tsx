      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="prose dark:prose-invert max-w-none space-y-6 text-gray-700 dark:text-gray-300">
          <section>
            ...
            <p>
              Настоящая Политика определяет порядок обработки персональных данных посетителей сайта https://airent24.ru. Оператор персональных данных — индивидуальный предприниматель Албу Валентин Георгиевич, ИНН 890400136608, ОГРНИП 305890404100029, регион регистрации: Ямало-Ненецкий автономный округ, г. Новый Уренгой (далее — «Оператор»).
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Для получения сведений, уточнения или удаления данных, а также отзыва согласия направьте обращение оператору ИП Албу Валентину Георгиевичу (ИНН 890400136608, ОГРНИП 305890404100029) на: <a href="mailto:privacy@airent24.ru" className="text-blue-600 hover:underline">privacy@airent24.ru</a>
            </p>
          </section>
